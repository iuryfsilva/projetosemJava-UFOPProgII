...
public class Aluno extends Pessoa{
	...
	public void matricular(String disciplina) {
		...
		if(this.estaMatriculadoNaDisciplina(disciplina)) {
			System.out.println("Já existe a matricula em " + disciplina);
			return;//não execulta o restante do método caso seja verdadeira
		}
		if(this.indiceDisciplina < 10) {
			this.listaDeDisciplinas[this.indiceDisciplina] = disciplina;
			this.indiceDisciplina++;
		}else System.out.println("O aluno " + this.getNome() + " já esta matriculado em 10 disciplinas! "); 
